...
$(document).on("pagebeforeshow", "#details-page", function () {
 ...
 info_view += '<div >'
                       ...
                       + '<img src="'+data.img+'" align="middle" onerror=this.src="https://ritzbethesda.pointofrentalcloud.com/img/no_image.gif" width="80" height="80" style="background-color:red;box-shadow:0px 1px 7px rgba(100,100,100,0.49);border-radius:40px"/>'
